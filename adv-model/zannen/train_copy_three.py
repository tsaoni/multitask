...
def parse_args() -> List[Namespace]:
    ...
    parser.add_argument('--victim_max_source_length', type=int, default=1024, help='')
    parser.add_argument('--struct2sent_max_source_length', type=int, default=1024, help='')
    parser.add_argument('--sent2struct_max_source_length', type=int, default=1024, help='')
    ...
    parser.add_argument('--sent2struct_data_dir', type=str, default=None, help='')
    parser.add_argument('--struct2sent_data_dir', type=str, default=None, help='')
    parser.add_argument('--victim_data_dir', type=str, default=None, help='')
...
def split_args(args):
    ...
    module_args = [
        'model_name_or_path', 'cache_dir', 'config_name', 'tokenizer_name', 'num_labels', 
        'victim_max_source_length', 'struct2sent_max_source_length', 'sent2struct_max_source_length', 
        ...
        'eval_beams', 'src_lang', 'tgt_lang', 'length_penalty', 
        'sent2struct_data_dir', 'struct2sent_data_dir', 'victim_data_dir', 
